...
class virtualKeyboard(QtWidgets.QDialog):
    ...
    def create_keys(self):
        ...
        for key in range(len(self.key_buttons[3])):
            row_grids[3].addWidget(self.key_buttons[3][key], 0, key) #Add the forth row of buttons to the first grid
...
#        box_grid.addWidget(sc)
        ...
        #Title
        Cam1_label = QtWidgets.QLabel('Left Camera')
        Cam2_label = QtWidgets.QLabel('Right Camera')
        ...
        preview = QtWidgets.QPushButton("Start Preview")
        
        
        
        start = QtWidgets.QPushButton("Start Recording")
        start.clicked.connect(self.show_window_3) #Also call the RPi Recording
       
        
        box_grid.addWidget(Cam1_label, 0, 0, 1, 1)
        box_grid.addWidget(Cam2_label, 0, 2, 1, 1)
        
        box_grid.addWidget(label1, 1, 0, 1, 2)
        box_grid.addWidget(label2, 1, 2, 1, 2)
        
        box_grid.addWidget(back, 3, 0, 1, 1)
        box_grid.addWidget(preview, 2, 0, 1, 1)
        box_grid.addWidget(start, 2, 1, 1, 1)
...
#    app.autoSipEnabled() 
    ex = MainWindow()
#    ex.setStyleSheet("""QMainWindow {background: 'Black';} 
#                        QLabel { color: white }"""); #Change the background color
