...
stan_data = {'J':chessboard.shape[0], 'chessboard':chessboard, 'images': img_points, 
            'P': len(img_points), 'resolution': cl.resolution, 'trans': translations, 'sigma': 0.5}

fit = sm.sampling(data=stan_data, iter = 5000, chains=4, refresh = 1, control = {'adapt_delta': 0.99}) #Fit model  
