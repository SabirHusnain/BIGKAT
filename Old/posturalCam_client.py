...
class posturalCam:
    ...
    def start_UDP_server(self):
        ...
        print('UDP Server: starting server up on {} port {}'.format(server_address, server_address))
    ...
    def start_UDP_client(self, t):
        ...
        print('UDP Client: Sending message to UDP Server')
    ...
    def start_TCP_server(self):
        ...
        host = '192.168.0.3'  # Get local machine name
...
def cam2_client():
    ...
    myCam.start_UDP_client(10)  # Command server to record for 5 seconds
